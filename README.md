...
```bash
python manage.py shell --command='from core.tests import *'
```
...
##### 10) Iniciar sesión en el sistema (Puede cambiar la clave y usuario que se crea en el archivo core/tests.py del paso 7)
